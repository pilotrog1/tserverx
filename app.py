...
def convert_to_float_or_empty(value):
    ...
    if isinstance(value, str):
        ...
        try:
            ...
            return '' # No es un número válido, se guarda como vacío
    return '' # Si no es un tipo esperado, se guarda como vacío
    ...
    try:
        ...
        if productos:
            ...
            for item in productos:
                ...
                # Asegurar que los campos numéricos se guarden como float o cadena vacía
